 ...
 * -------------------------------------------------------------
 */
func bErrorPrint(string fmt, ...);
func displayBuffer(Buffer* ptr_Buffer);
int64 getFileSize(string fname);
int32 isNumber(const string ns);
func startReader(string, string, rune, int32, int32);
...
************************************************************
*/
func startReader(string program, string input, rune mode, int32 size, int32 increment) {
